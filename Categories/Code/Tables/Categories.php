...
namespace Jobs\Categories\Code\Tables;
 ...
 * Categories
 *
 * @ORM\Table(name="jobs_categories", indexes={@ORM\Index(name="parent_id_index", columns={"parent_id"}), @ORM\Index(name="created_by_index", columns={"created_by"}), @ORM\Index(name="modified_by_index", columns={"modified_by"})})
 * @ORM\Entity
